    ...
    <div id='testimonials' className={styles.container}>
      ...
      <div className={styles.testimonials}>
        <div className={styles.testimonial}>
          ...
          <p>I highly recommend Jackson for their exceptional programming skills. His proficiency in diverse languages, ability to solve complex problems, and collaborative mindset make him an invaluable asset to any team. Jackson consistently delivers high-quality solutions and is an outstanding contributor to any programming project.</p>
        </div>
      </div>
    </div>
  )
