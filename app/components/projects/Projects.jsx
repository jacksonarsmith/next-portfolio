...
export default function Projects() {
  const projects = [
    ...
    { title: 'ICO Website', description: "Developed the Imperial Contracting Ottawa [ICO] Home Renovations website using the MERN stack to showcase our Ottawa-based full home renovation expertise. The dynamic platform features a curated portfolio, captivating before-and-after gallery, and detailed service offerings, highlighting our commitment to quality craftsmanship. Leveraged modern web technologies for optimal performance and a seamless user experience. The inclusion of client testimonials and a user-friendly contact form underscores our dedication to client satisfaction.", github: 'https://github.com/jacksonarsmith/imperialcontractingottawa', link: 'https://imperialcontractingottawa.ca', image: '/ico-website.png'},
